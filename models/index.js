...
db.employee = require("../modules/employee/models/employee")(sequelize, Sequelize);
...
db.useraccount.hasOne(db.employee, { foreignKey: "id_user" });
db.employee.belongsTo(db.useraccount, { foreignKey: "id_user" });
